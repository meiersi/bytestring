...
import qualified Data.ByteString.Lazy.Builder.Internal
...
-}
          ...
          benchBInts "mapM_ (left-assoc)" $
            fromPut . mapM_ (\x -> do {putIntHost x; putIntHost x})
